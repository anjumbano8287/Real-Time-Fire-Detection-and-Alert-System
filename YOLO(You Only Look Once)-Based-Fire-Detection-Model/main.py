...
pygame.mixer.init()
model = YOLO(r'C:\Users\HP\OneDrive\Desktop\Real Time Fire Detection And Alert System\YOLO(You Only Look Once)-Based-Fire-Detection-Model\fire.pt')
...
def play_siren():
    siren_sound = pygame.mixer.Sound(r"C:\Users\HP\OneDrive\Desktop\Real Time Fire Detection And Alert System\sound-effect.mp3")
